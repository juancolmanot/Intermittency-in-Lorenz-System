...
int main(int argc, char *argv[]) {
    ...
    // ===============================================================================
    unsigned int counts_region[params.n_regions];
    ...
    for (int i = 0; i < params.n_regions; i++) {
        ...
        long double Mi = 0.0;
        counts_region[i] = npoints_domain;
        ...
        // ===============================================================================
        for (unsigned int k = 0; k < npoints_domain; k++) {
            M[(size_t)(i * 3)][k] = x_dom[k];
            M[(size_t)(i * 3 + 1)][k] = M_dom[k];
            M[(size_t)(i * 3 + 2)][k] = bi + mi * x_dom[k];
        }
    ...
    for (int i = 0; i < params.n_regions; i++) {
        for (unsigned int j = 0; j < counts_region[i]; j++) {
